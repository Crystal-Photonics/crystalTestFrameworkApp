#ifndef DUMMYCOMMUNICATIONDEVICE_H
#define DUMMYCOMMUNICATIONDEVICE_H

#include "communicationdevice.h"
#include "export.h"
#include <QObject>

class EXPORT DummyCommunicationDevice final : public CommunicationDevice {
    Q_OBJECT
    public:
    DummyCommunicationDevice();
...
#endif // DUMMYCOMMUNICATIONDEVICE_H

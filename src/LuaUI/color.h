...
struct Color {
	Color(const std::string &name); //!<\brief Creates a color by name.
	...
	Color(int r, int g, int b); //!<\brief Creates a color by rgb values.
	...
	Color(int rgb); //!<\brief Creates a color by rgb values.

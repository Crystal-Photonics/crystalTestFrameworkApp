...
\brief  An UserWaitLabel is an ordinary text label together with an moving
 ...
 to indicate a waiting state.
  \image html UserWaitLabel.png Simple UserWaitLabel example
  \image latex UserWaitLabel.png Simple UserWaitLabel example
  \image rtf UserWaitLabel.png Simple UserWaitLabel example
  \image html UserWaitLabel2.png UserWaitLabel with progress bar
  \image latex UserWaitLabel2.png UserWaitLabel with progress bar
  \image rtf UserWaitLabel2.png UserWaitLabel with progress bar
 */
